...
namespace PPTReport
{
    public static class RunReportPPt
    {
        public static void setRporte(string ruta)
        {
            ...
            //Content format
            string text = File.ReadAllText(ruta + "description.txt");
