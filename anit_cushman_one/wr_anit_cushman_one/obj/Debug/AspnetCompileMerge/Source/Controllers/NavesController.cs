...
namespace wr_anit_cushman_one.Controllers
{
    ...
    public class NavesController : Controller
    {
        ...
        public ActionResult Create(int? id)
        {
            ...
            tsg002_nave_industrial tsg002_nave_industrial = null;
            tsg009_ni_dt_gral tsg009_ni_dt_gral = null;
            tsg020_ni_servicio tsg020_ni_servicio = null;
            tsg023_ni_precio tsg023_ni_precio = null;
            tsg025_ni_contacto propietario = null;
            tsg025_ni_contacto administrador = null;
            tsg025_ni_contacto corredor = null;
        ...
        public ActionResult GeneraPdfSum(int estado, int municipio, int colonia)
        {
           ...
           cell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            foreach (var group in query)
            {
                ...
                if ((i + 1) % 2 == 0)
                {
                    ...
                    row.BorderColor = new BaseColor(255, 255, 255);
                    table.AddCell(row);
                    row = new PdfPCell(new Phrase(group.nb_tp_lampara, new Font(Vn_Helvetica, 12, Font.NORMAL, BaseColor.BLACK)));
                    row.BackgroundColor = new BaseColor(159, 181, 180);
                    row.BorderColor = new BaseColor(255, 255, 255);
                    table.AddCell(row);
                    row = new PdfPCell(new Phrase(group.nb_sist_inc.ToString(), new Font(Vn_Helvetica, 12, Font.NORMAL, BaseColor.BLACK)));
                    row.BackgroundColor = new BaseColor(159, 181, 180);
                    row.BorderColor = new BaseColor(255, 255, 255);
                    table.AddCell(row);
